package pegasus.application.web.rest;

import pegasus.application.PegasusApp;
import pegasus.application.config.Constants;
import pegasus.application.domain.Authority;
import pegasus.application.domain.User;
import pegasus.application.repository.AuthorityRepository;
import pegasus.application.repository.UserRepository;
import pegasus.application.security.AuthoritiesConstants;
import pegasus.application.service.MailService;
import pegasus.application.service.UserService;
import pegasus.application.service.dto.PasswordChangeDTO;
import pegasus.application.service.dto.UserDTO;
import pegasus.application.web.rest.errors.ExceptionTranslator;
import pegasus.application.web.rest.vm.KeyAndPasswordVM;
import pegasus.application.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = PegasusApp.class)
