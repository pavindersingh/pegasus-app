package pegasus.application.repository;

import pegasus.application.PegasusApp;
import pegasus.application.config.Constants;
import pegasus.application.config.audit.AuditEventConverter;
import pegasus.application.domain.PersistentAuditEvent;
...
import static pegasus.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
